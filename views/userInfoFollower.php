    ...
    <div id="content" class="row m-0" style="height:100%;background-color: rgba(0,0,0,0.03);">
        ...
        <div class="col-lg-12 card mx-auto p-0 pt-5 d-flex" style="border-bottom: none;">
                ...
                <div class="w-100 m-md-0 mx-auto">
                    <div class="d-flex justify-content-around w-75 mx-auto mt-4">
                        ...
                        <div class="h5 text-muted" style="white-space: nowrap;">
                            <a href="../views/userInfoFollowing.php?id=<?= $id ?>" class="text-dark text-decoration-none text-muted" type="submit" style="user-select: none;"><?= "following: " . (($follow_user_array->num_rows) - 1) ?></a>
                        </div>
                        <!-- follower -->
                        <div class="h5 " style="white-space: nowrap;margin:0;border-bottom:1px solid black;">
                            <?= "follower: " . (($follower_user_array->num_rows) - 1) . "<br>"; ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mx-auto w-50 text-center">
                <?php
                $follower_user_id = $follow_obj->getFollower($id);
                while ($follower_user_array = $follower_user_id->fetch_assoc()) {
                    if ($id == $follower_user_array['user_id']) {
                        continue;
                    }
                ?>
                    <div class="card-content card w-75 mt-4 mx-auto">
                        <div class="bg-white">
                            <div class="d-flex">
                                <?php
                                $user_detail = $user_obj->getUser($follower_user_array['user_id']);
                                ?>
