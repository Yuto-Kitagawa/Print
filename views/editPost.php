    ...
    <div id="content" class=" m-0" style="height:100vh;background-color: rgba(0,0,0,0.03);">
        ...
        <form action="../actions/editPost.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card h-25 mx-auto col-md-6 col-9 mb-3">
                <textarea style="overflow: hidden;resize:none;outline:none;" class="border-0" name="post_content" id="post_content" cols="30" maxlength="255" rows="6"><?= $_SESSION['content'] ?></textarea>
            </div>
